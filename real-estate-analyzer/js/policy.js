...
(function (root, factory) {
  ...
  // ── 재건축·정비사업 ───────────────────────────────────────────────────
  const RECON = {
    // 정비사업 12단계 (호갱노노·정비사업 정보몽땅과 같은 순서)
    stages: ['해당없음', '기본계획수립', '재건축진단', '정비구역지정', '추진위원회승인', '조합설립인가', '사업시행인가', '관리처분인가', '이주철거', '착공', '일반분양승인', '준공'],
    stageLabels: { 재건축진단: '안전진단 (재건축진단)', 이주철거: '이주·철거신고', 착공: '착공신고', 준공: '준공인가·이전고시' },
    yearsToMoveIn: { 기본계획수립: 13, 재건축진단: 12, 정비구역지정: 10, 추진위원회승인: 9, 조합설립인가: 8, 사업시행인가: 6, 관리처분인가: 4.5, 이주철거: 4, 착공: 3, 일반분양승인: 2.5, 준공: 0 },
